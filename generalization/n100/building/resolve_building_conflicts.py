...
def resolve_building_conflicts():
    ...
    custom_arcpy.select_attribute_and_make_permanent_feature(
        ...
        output_name=Building_N100.resolve_building_conflicts__selection_area_resolve_building_conflicts__n100.value,
    )
    ...
    for selection in selections:
        custom_arcpy.select_location_and_make_permanent_feature(
            ...
            select_features=Building_N100.resolve_building_conflicts__selection_area_resolve_building_conflicts__n100.value,
