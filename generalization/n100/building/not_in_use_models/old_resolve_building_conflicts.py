...
def creating_append_layers():
    ...
    arcpy.CreateFeatureclass_management(
        ...
        template=Building_N100.calculate_point_values___points_going_into_rbc___n100_building.value,
    )
...
def pre_calculation():
    ...
    arcpy.management.CalculateFields(
        in_table=Building_N100.simplify_building_polygons__simplified_grunnriss__n100.value,
