...
def resolve_building_conflicts():
    ...
    building_squares = "building_squares"
    road = "road"
    railway = "railway"
    ...
    resolve_building_conficts_config = {
        ...
        "params": {
            ...
            "lyrx_files": {
                "building_squares": (building_squares, "reference"),
                "building_polygons": (building_polygons, "reference"),
                "begrensningskurve": (begrensningskurve, "reference"),
                "road": (road, "reference"),
                "railway_station": (railway_station, "reference"),
